...
<div id="how-to-debug"></div>**OK，到了这一步，先让我们试运行一下上面的程序吧**。运行程序(Debug xxx.exe)的方法有三种：  
...
[the-1st-part]:http://lanfengming.com/blog/Labwindows-tutorial-chapter3-part1.html/
